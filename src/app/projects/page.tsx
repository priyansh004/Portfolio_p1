...
const page = () => {
  return (
    <div className=" lg:max-w-[70%] lg:m-auto min-h-max overflow-hidden pt-8 	">
      <div className=" m-8 italic text-3xl md:text-[100px] text-center flex flex-row justify-center item-center 	">
        Projects
        <Link
      ...
      <div className="flex pl-4 pr-4 flex-col pb-7 md:pb-0 mb-32">
